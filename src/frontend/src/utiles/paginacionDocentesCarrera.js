 ...
 * @return {*} void
 */
 export function paginacionDocentes(datos,divicionDatos,numeroActual,tbody,contNumeros,funcionRefrescar = null,columnaBusqueda = null,valor=null){
    ...
    for(let i = 1 ; i <= totalNumeros ; i++){
        ...
        button.addEventListener('click',() => { // boton esta selecionado 
                 paginacionDocentes(datos,divicionDatos,i,tbody,contNumeros,funcionRefrescar);
