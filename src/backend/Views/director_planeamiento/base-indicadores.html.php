...
<!-- Vistas  -->
<template id="template-criterios">
<div class="w-100">
<table class="table table-striped-columns w-100">
  ...
  <div class="100 d-flex justify-content-center align-items-center pt-1">
    <button id="ingreso-criterio" type="submit"
...
<template id="template-estandares">
<div class="w-100">
<table class="table table-striped-columns w-100">
    <thead>
      <tr>
...
<template id="template-elementos-fundamentales">
<div class="w-100">
<table class="table table-striped-columns w-100">
    <thead>
      <tr>
  ...
  <div class="contenedor-numeros-paginacion d-flex justify-content-center"></div>
  <div class="100 d-flex justify-content-center align-items-center pt-1">
    <button id="ingreso-elemento" type="submit"
    class="boton boton-enviar is-hover-boton-enviar ps-4 pe-4 d-flex aling-items-center gap-flex-1">
        <span class="material-icons text-white">&#xef40;</span>
        Ingresar Elemento Fundamental
    </button>
  </div>
</div>
</template>

<template id="template-componentes">
<div class="w-100">
<table class="table table-striped-columns w-100">
    <thead>
      <tr>
  ...
  <div class="contenedor-numeros-paginacion d-flex justify-content-center"></div>
  <div class="100 d-flex justify-content-center align-items-center pt-1">
    <button id="ingreso-componente" type="submit"
    class="boton boton-enviar is-hover-boton-enviar ps-4 pe-4 d-flex aling-items-center gap-flex-1">
        <span class="material-icons text-white">&#xef40;</span>
        Ingresar Elemento Fundamental
    </button>
...
<template id="template-evidencias">
...
<table class="table table-striped-columns w-100">
  ...
  <div class="contenedor-numeros-paginacion d-flex justify-content-center"></div>
  <div class="100 d-flex justify-content-center align-items-center pt-1">
    <button id="ingreso-evidencias" type="submit"
    class="boton boton-enviar is-hover-boton-enviar ps-4 pe-4 d-flex aling-items-center gap-flex-1">
        <span class="material-icons text-white">&#xef40;</span>
        Ingresar Fuente de Información
    </button>
  </div>
</div>
