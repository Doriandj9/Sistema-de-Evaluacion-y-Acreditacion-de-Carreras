                ...
                <thead>
                    <tr class="titulo-tablas">
                        <th class="bg-secondary text-white" colspan="7">
                            ...
                            <strong>Lista de Directores del Departamentode Planeación</strong>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        <th class="bg-primary text-white text-center"
class="bg-primary text-white text-center">Cedula</th>
                        <th class="bg-primary text-white text-center"
...
<div class="desborde-auto barra-personalizada padding-all-1">
    ...
    <table class="table table-striped-columns w-100 sombra m-0">
        ...
        <div class="row w-100 sombra m-0 pt-2 pb-4">
            <div class="col-4">
            <div class="mb-1">
                <label for="cedula" class="form-label">Ingrese el Numero de Cedula</label>
            ...
            <div class="mb-1">
                <label for="telefono" class="form-label">Ingrese el Numero de Telefono</label>
